...
public class GetProjectsByEmployeeIT extends AbstractIntegrationTest {
    ...
    void getProjectsForEmployee() throws Exception {
        ...
        project1.setClientContactName("Contact A");
        ...
        project2.setClientContactName("Contact B");
        ...
        this.mockMvc.perform(get("/api/v1/employees/" + e2.getEmployeeId() + "/projects", 101L))
                ...
                .andExpect(jsonPath("$[*].projectId", containsInAnyOrder(saved1.getId().intValue(), saved2.getId().intValue())));
    }
    ...
    void getProjectForEmployeeById() throws Exception {
        ...
        project.setClientContactName("Contact C");
